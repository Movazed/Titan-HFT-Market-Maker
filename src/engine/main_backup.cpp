...
//./hft_live | python3 dashboard.py  -> this shows with dashboard....
//. source ~/HFT_Engine/Quant_Research/venv/bin/activate -> activation of env  use this before turning on py files or dashboard..